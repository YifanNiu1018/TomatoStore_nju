...
import {ElMessage, ElForm, ElLoading, ElCard, ElFormItem, ElInput, ElButton, ElUpload, ElImage} from 'element-plus'
  ...
  <div class="ad-update-container">
    <ElCard class="form-card">
      ...
      <div class="header-section">
        ...
        <p class="page-subtitle">修改您的商品推广广告信息</p>
      </div>
      ...
      <ElForm ref="formRef" :model="adForm" :rules="rules" label-width="0" class="ad-form">
        ...
        <div class="form-section">
          ...
          <div class="section-content">
            <ElFormItem prop="imageUrl" class="form-item">
        ...
        <div class="form-actions">
          <ElButton
            ...
            size="large"
          >
            <span v-if="isUploading">保存中...</span>
